...
<html>
    ...
    <div style="height:100%";>
        ...
        <div class="pitanje">1. Napišite program koji se spaja na bazu fakultet i iz tablice stud 
            dohvaća sve studente koji se zovu Ivan. Zatim treba ispisati matične 
            brojeve i prezimena tih studenata.</div>

        <div class="odgovor">

            <?php
            $query = "SELECT stud.imeStud AS Ime, stud.prezStud AS Prezime, stud.mbrStud AS 'Matični broj studenta'
                        FROM stud
                        WHERE
                        stud.imeStud='Ivan' order by stud.prezStud;";
            ...
            //novo
           // echo "Ukupno stupaca u query-u iz tablice stud je: " . $result->field_count;
            //echo "<hr>";
            //echo "Ukupno studenata s imenom Ivan je: " . $result->num_rows;
           // echo "<hr>";
